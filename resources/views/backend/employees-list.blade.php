...
<div class="row align-items-center">
	...
	<div class="col-auto float-right ml-auto">
		<a href="javascript:void(0)" class="btn add-btn" data-toggle="modal" data-target="#add_employee"><i class="fa fa-plus"></i> Tambah Pegawai</a>
					...
					<tr>
						<td>
							<h2 class="table-avatar">
								<a href="javascript:void(0)" class="avatar"><img alt="avatar" src="@if(!empty($employee->avatar)) {{$employee->avatar}} @else assets/img/profiles/default.jpg @endif"></a>
						...
						<td class="text-right">
							<div class="dropdown dropdown-action">
								...
								<div class="dropdown-menu dropdown-menu-right">
									<a data-id="{{$employee->id}}" data-firstname="{{$employee->firstname}}" data-lastname="{{$employee->lastname}}" data-email="{{$employee->email}}" data-phone="{{$employee->phone}}" data-avatar="{{$employee->avatar}}" data-company="{{$employee->company}}" data-birthday="{{$employee->birthday}}" data-quota="{{$employee->leaves_quota}}" data-designation="{{$employee->designation->id}}" data-department="{{$employee->department->id}}" data-role={{$employee->role}} class="dropdown-item editbtn" href="javascript:void(0)" data-toggle="modal"><i class="fa fa-pencil m-r-5"></i> Edit</a>
