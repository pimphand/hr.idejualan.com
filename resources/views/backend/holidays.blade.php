...
<div class="row align-items-center">
    <div class="col">
        <h3 class="page-title">Hari Libur</h3>
        <ul class="breadcrumb">
    ...
    <div class="col-auto float-right ml-auto">
        <a href="#" class="btn add-btn" data-toggle="modal" data-target="#add_holiday"><i class="fa fa-plus"></i> Tambah Hari Libur</a>
    </div>
</div>
@endsection
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title">Edit Liburan</h5>
                                    ...
                                    <div class="modal-body">
                                        <form action="{{route('holidays')}}" method="post">
                                            ...
                                            <div class="form-group">
                                                <label>Tanggal Liburan <span class="text-danger">*</span></label>
...
<div class="modal custom-modal fade" id="add_holiday" role="dialog">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Tambah Liburan</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="" method="POST">
                    @csrf
                    <div class="form-group">
                        <label>Nama Liburan <span class="text-danger">*</span></label>
