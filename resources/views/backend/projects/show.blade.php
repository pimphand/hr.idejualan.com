                        ...
                        <ul class="list-box">
                            ...
                            <li>
                                <a href="#">
                                    <div class="list-item">
                                        <div class="list-left">
                                            <span class="avatar"><img alt="avatar" src="{{ !empty($leader->avatar) ? $leader->avatar : asset('assets/img/user.jpg')}}"></span>
                                        </div>
                                        <div class="list-body">
                        ...
                        <ul class="list-box">
                            ...
                            <li>
                                <a href="#">
                                    <div class="list-item">
                                        <div class="list-left">
                                            <span class="avatar"><img alt=""  src="{{ !empty($member->avatar) ? $member->avatar : asset('assets/img/user.jpg')}}"></span>
                                        </div>
                                        <div class="list-body">
