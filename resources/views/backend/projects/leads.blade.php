                        ...
                        <td>
                            <h2 class="table-avatar">
                                ...
                                <a href="#" class="avatar" data-toggle="tooltip" title="{{$leader->firstname.' '.$leader->lastname}}">
                                    <img src="{{ !empty($leader->avatar) ? $leader->avatar : asset('assets/img/user.jpg')}}">
                                </a>
                        ...
                        <td>
                            <ul class="team-members">
                                @foreach ($project->team as $team_member)
                                    ...
                                    @endphp
                                    <li>
                                        <a href="javascript:void(0)" data-toggle="tooltip" title="{{$member->firstname.' '.$member->lastname}}"><img  src="{{ !empty($member->avatar) ? $member->avatar : asset('assets/img/user.jpg')}}"></a>
                                    </li>
                                @endforeach
                            </ul>
                        </td>
