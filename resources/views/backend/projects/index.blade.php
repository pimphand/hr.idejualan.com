            ...
            <div class="card-body">
                    ...
                    <ul class="team-members">
                        <li>
                            <a href="#" data-bs-toggle="tooltip" title="{{$leader->firstname.' '.$leader->lastname}}">
                                <img alt="avatar"  src="{{ !empty($leader->avatar) ? $leader->avatar : asset('assets/img/user.jpg')}}">
                            </a>
                        </li>
                    </ul>
                </div>
                <div class="project-members m-b-15">
                    ...
                    <ul class="team-members">
                        ...
                        @endphp
                        <li>
                            <a href="#" data-bs-toggle="tooltip" title="{{$member->firstname.' '.$member->lastname}}"><img  src="{{ !empty($member->avatar) ? $member->avatar : asset('assets/img/user.jpg')}}"></a>
                        </li>
                        @endforeach
                    </ul>
                </div>
