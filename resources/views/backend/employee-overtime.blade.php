...
<div class="row align-items-center">
	<div class="col">
		<h3 class="page-title">Lembur Pegawai</h3>
		<ul class="breadcrumb">
	...
	<div class="col-auto float-right ml-auto">
		<a href="#" class="btn add-btn" data-toggle="modal" data-target="#add_overtime"><i class="fa fa-plus"></i> Tambah Lembur</a>
	</div>
</div>
@endsection
                    ...
                    <tr>
                        ...
                        <td>
                            <h2 class="table-avatar blue-link">
                                <a href="javascript:void(0)" class="avatar"><img alt="avatar"  src="{{ !empty($overtime->employee->avatar) ? $overtime->employee->avatar : asset('assets/img/user.jpg') }}"></a>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('overtime')}}" method="post">
                    ...
                    <div class="form-group">
                        <label>Tanggal Lembur <span class="text-danger">*</span></label>
                        <div class="cal-icon">
                            <input class="form-control datetimepicker" name="date" type="text">
                        </div>
                    </div>
                    <div class="form-group">
                        <label>Jumlah Jam Lembur <span class="text-danger">*</span></label>
