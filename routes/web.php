...
Route::group(['middleware'=>['auth']], function (){
    ...
    Route::get('employees/attendance/export',[EmployeeAttendanceController::class,'export'])->name('attendance.export');

    Route::get('employees/attendanceOutside',[EmployeeAttendanceController::class,'outside'])->name('employees.attendanceOutside');
    Route::put('employees/attendanceOutside/setApproved/{attendance}',[EmployeeAttendanceController::class,'setApproved'])->name('employees.attendanceOutside.setApproved');
    Route::put('employees/attendanceOutside/setRejected/{attendance}',[EmployeeAttendanceController::class,'setRejected'])->name('employees.attendanceOutside.setRejected');
    ...
    Route::get('employee-leave/export',[EmployeeLeaveController::class,'export'])->name('leave.export');
    ...
    Route::put('appeal/setApproved/{appeal}',[AppealController::class,'approve'])->name('appeal.approve');
    Route::put('appeal/setRejected/{appeal}',[AppealController::class,'reject'])->name('appeal.reject');
});
